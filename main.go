...
import (
	"bitbucket.org/welovetravel/backup/archiver"
	"bitbucket.org/welovetravel/backup/base"
	"bitbucket.org/welovetravel/backup/compressor"
	"bitbucket.org/welovetravel/backup/encryptor"
	h "bitbucket.org/welovetravel/backup/helpers"
	"bitbucket.org/welovetravel/backup/notifier"
	"bitbucket.org/welovetravel/backup/source/database"
	"bitbucket.org/welovetravel/backup/source/local"
	"bitbucket.org/welovetravel/backup/splitter"
	"bitbucket.org/welovetravel/backup/storage"
	"flag"
	"fmt"
